...
static void tick_handler(struct tm *tick_time, TimeUnits units_changed) {
  ...
  text_layer_set_text(s_time_layer_minute, "00");
...
static void main_window_load(Window *window) {
  ...
  s_time_layer_hour = text_layer_create(
      GRect(0, PBL_IF_ROUND_ELSE(29, 26), bounds.size.w, 50));
  s_time_layer_minute = text_layer_create(
      GRect(0, PBL_IF_ROUND_ELSE(87, 78), bounds.size.w, 50));
  ...
  text_layer_set_text(s_time_layer_hour, "00:00");
  text_layer_set_font(s_time_layer_hour, fonts_get_system_font(FONT_KEY_ROBOTO_BOLD_SUBSET_49));
  text_layer_set_text_alignment(s_time_layer_hour, GTextAlignmentCenter);
  text_layer_set_text(s_time_layer_minute, "00:00");
  text_layer_set_font(s_time_layer_minute, fonts_get_system_font(FONT_KEY_ROBOTO_BOLD_SUBSET_49));
